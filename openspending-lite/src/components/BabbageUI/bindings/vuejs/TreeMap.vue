...
<template>
    ...
    <!--
    <div>
        <button @click="onIFrame()">BubbleTree</button>
    </div>
    <div>
        <iframe
                src="{{ iframeUrl }}"
    ...
    export default {
        ...
        data () {
            return {
                ...
                iframeUrl: "http://next.openspending.org/viewer/embed/0638aadc448427e8b617257ad01cd38a:kpkt-propose-2016-hierarchy-test?measure=Amount.sum&order=Amount.sum%7Cdesc&visualizations%5B%5D=Treemap&groups%5B%5D=functional_classification_2.Item&rows%5B%5D=budget_line_id_2.UUID&columns%5B%5D=budget_line_id_2.UUID&filters=economic_classification_Level_2.Level_2_x_3%7C10000"
            }
        },
        watch: {
            'state': function (val, oldval) {
                // Init state has changed; refresh?
        ...
        events: {
            'treemap-click': function () {
                console.error("TREEMAPC")
            },
            'beginAggregate': function () {
                // Only Vue events are catched!!
        ...
        methods: {
            ...
            onIFrame: function () {
                // &visualizations%5B%5D=BubbleTree
                this.iframeUrl = "http://next.openspending.org/viewer/embed/0638aadc448427e8b617257ad01cd38a:kpkt-propose-2016-hierarchy-test?measure=Amount.sum&order=Amount.sum%7Cdesc&visualizations%5B%5D=BubbleTree&groups%5B%5D=functional_classification_2.Item&rows%5B%5D=budget_line_id_2.UUID&columns%5B%5D=budget_line_id_2.UUID&filters=economic_classification_Level_2.Level_2_x_3%7C10000"
